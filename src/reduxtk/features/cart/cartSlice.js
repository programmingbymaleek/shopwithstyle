...
const updateCart = (state) => {
  ...
  state.count = state.cartItems.reduce((accumulator, current) => accumulator + current.quantity, 0);
}

export const { setToogleCart, deletCartItem, incrementCartItem, decrementCartItem, addItemsTocart } = cartSlice.actions;
